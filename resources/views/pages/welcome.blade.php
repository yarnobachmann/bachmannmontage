...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-5" style="background:rgba(229,229,229,0.8); padding: 3%; padding-top: 1%; padding-bottom: 0.5%; left: 12%; top: 50%; height:33%; width:30%; position:absolute;">
    ...
    <div class="col-sm-4 text-left" style="background:rgba(229,229,229,0.8); top: 50%; left: 52%; position: absolute; padding-bottom: 6%;">
      <h1>Welcome</h1>
